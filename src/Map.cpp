    ...
    if (!parsed)
    {
        ...
        while (*mapData != "\0")
        {
            ...
            if (!ignoreLine)
            {
                ...
                // processando blocos de limite quando usados como primeira coluna
                // para ajuste da câmera
                if (*mapData != "/")
                {
                    if (maxWidth < x)
                    {
                ...
                case 'i':
                    if (parseBlocks)
                        blocks.push_back(new EyesClosedBlock(Vector2(x, y), Vector2(TILE_WIDTH, TILE_WIDTH), DEBUGGABLE_TILE_COLOR));
                    break;
                case 'y':
                    if (parseBlocks)
                        blocks.push_back(new EyesOpenedBlock(Vector2(x, y), Vector2(TILE_WIDTH, TILE_WIDTH), DEBUGGABLE_TILE_COLOR));
                    break;
                case 's':
                    if (parseBlocks)
                        blocks.push_back(new StoneBlock(Vector2(x, y), Vector2(TILE_WIDTH, TILE_WIDTH), DEBUGGABLE_TILE_COLOR));
                    break;
                case 'w':
                    if (parseBlocks)
                        blocks.push_back(new WoodBlock(Vector2(x, y), Vector2(TILE_WIDTH, TILE_WIDTH), DEBUGGABLE_TILE_COLOR));
                    break;
                case 'g':
                    if (parseBlocks)
                        blocks.push_back(new GlassBlock(Vector2(x, y), Vector2(TILE_WIDTH, TILE_WIDTH), DEBUGGABLE_TILE_COLOR));
                    break;
                case 'c':
                    if (parseBlocks)
                        blocks.push_back(new CloudBlock(Vector2(x, y), Vector2(TILE_WIDTH, TILE_WIDTH), DEBUGGABLE_TILE_COLOR));
                    break;
                case 'v':
                    if (parseBlocks)
                        if (parseBlocks)
                            blocks.push_back(new InvisibleBlock(Vector2(x, y), Vector2(TILE_WIDTH, TILE_WIDTH), DEBUGGABLE_TILE_COLOR));
                    break;
                case 'h':
                ...
                case '!':
                    if (parseBlocks)
                        blocks.push_back(new ExclamationBlock(Vector2(x, y), Vector2(TILE_WIDTH, TILE_WIDTH), DEBUGGABLE_TILE_COLOR));
                    break;
                case '?':
                    if (parseBlocks)
                        blocks.push_back(new QuestionBlock(Vector2(x, y), Vector2(TILE_WIDTH, TILE_WIDTH), DEBUGGABLE_TILE_COLOR));
                    break;
                case 'm':
                    if (parseBlocks)
                        blocks.push_back(new QuestionMushroomBlock(Vector2(x, y), Vector2(TILE_WIDTH, TILE_WIDTH), DEBUGGABLE_TILE_COLOR));
                    break;
                case 'f':
                    if (parseBlocks)
                        blocks.push_back(new QuestionFireFlowerBlock(Vector2(x, y), Vector2(TILE_WIDTH, TILE_WIDTH), DEBUGGABLE_TILE_COLOR));
                    break;
                case 'u':
                    if (parseBlocks)
                        blocks.push_back(new QuestionOneUpMushroomBlock(Vector2(x, y), Vector2(TILE_WIDTH, TILE_WIDTH), DEBUGGABLE_TILE_COLOR));
                    break;
                case '+':
                    if (parseBlocks)
                        blocks.push_back(new QuestionThreeUpMoonBlock(Vector2(x, y), Vector2(TILE_WIDTH, TILE_WIDTH), DEBUGGABLE_TILE_COLOR));
                    break;
                case '*':
                    if (parseBlocks)
                        blocks.push_back(new QuestionStarBlock(Vector2(x, y), Vector2(TILE_WIDTH, TILE_WIDTH), DEBUGGABLE_TILE_COLOR));
                    break;
                / bondarie tiles case '/':
                ...
                // peças de cenário
                case '{':
                    backScenarioTiles.push_back(new Tile(Vector2(x, y), Vector2(TILE_WIDTH, TILE_WIDTH), DEBUGGABLE_TILE_COLOR, "tileCourseClearPoleBackTop", true));
                    break;
                case '[':
                    backScenarioTiles.push_back(new Tile(Vector2(x, y), Vector2(TILE_WIDTH, TILE_WIDTH), DEBUGGABLE_TILE_COLOR, "tileCourseClearPoleBackBody", true));
                    break;
                case '}':
                    frontScenarioTiles.push_back(new Tile(Vector2(x, y), Vector2(TILE_WIDTH, TILE_WIDTH), DEBUGGABLE_TILE_COLOR, "tileCourseClearPoleFrontTop", true));
                    break;
                case ']':
                    frontScenarioTiles.push_back(new Tile(Vector2(x, y), Vector2(TILE_WIDTH, TILE_WIDTH), DEBUGGABLE_TILE_COLOR, "tileCourseClearPoleFrontBody", true));
                    break;

                // blocos de A a Z (dependente do mapa - futuro)
                default:
                ...
                case 'o':
                    if (parseItems)
                        staticItems.push_back(new Coin(Vector2(x + 4, y), Vector2(25, 32), YELLOW));
                    break;
                case '=':
                    if (parseItems)
                        staticItems.push_back(new CourseClearToken(Vector2(x - TILE_WIDTH, y), Vector2(64, 32), LIGHTGRAY));
                    break;
                /*case 'm':
