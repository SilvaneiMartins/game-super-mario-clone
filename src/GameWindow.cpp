/**
 * @file GameWindow.cpp
 * @brief GameWindow classe de implementação.
 * @version 0.1
 * @date 25/02/2024
...
GameWindow::GameWindow() : GameWindow(false)
{
}

GameWindow::GameWindow(bool initAudio) :
    GameWindow(800, 450, "Titulo da Janela", 60, true, false, false, false, false, false, initAudio)
{
}
...
GameWindow::GameWindow(int width, int height, std::string title, int targetFPS, bool antialiasing, bool resizable, bool fullScreen,
                       bool undecorated, bool alwaysOnTop, bool alwaysRun, bool initAudio) : width(width),
                                                                                             height(height),
...
/**
 * @brief Destrua o objeto Game Window
 */
...
void GameWindow::init()
{
    if (!initialized)
    {
        ...
        SetWindowIcon(LoadImage("recurso/images/gui/appIcon.png"));
        SetExitKey(0);
